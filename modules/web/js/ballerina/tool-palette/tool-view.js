...
var toolView = Backbone.View.extend({
    ...
    toolTemplate: _.template("<div id=\"<%=id%>\" class=\"tool-block tool-container <%=classNames%>\"  " +
            "data-placement=\"bottom\" data-container=\"body\" data-template=\"<div class='tooltip tool-palette' role='tooltip'>" +
            "<div class='tooltip-arrow'></div><div class='tooltip-inner'></div></div>\" data-toggle=\"tooltip\" title='<%=title%>'> " +
            "<i class=\"<%=cssClass%>\"></i> " +
